// Mendefinisikan fungsi untuk memutar audio
function playAudio() {
  const linkmp3 = "img/audio.mp3"; // Ganti dengan jalur ke file audio Anda
  const audio = new Audio(linkmp3); // Membuat objek audio dengan path yang diberikan
...
// Smooth Scroll
        ...
        // ScrollMagic
        var controller = new ScrollMagic.Controller({ loglevel: 2 });
